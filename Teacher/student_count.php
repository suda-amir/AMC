                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form action = "student_count_back.php" method = "post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">ROLL NO</label>
                                            <div class="col-lg-10">
                                                <input type = "number" name ="roll" class="form-control input-sm m-bot15">
                                            </div>
                                        </div>
                                        <!--  <div class="form-group">
<label class="col-sm-2 control-label col-lg-2" for="inputSuccess">SUBJECT</label>
...
<option value = "ISEE">TOC</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-xs-11">
                                                <input name="date" class="form-control form-control-inline input-medium default-date-picker"  size="20" type="text" value="" name = "start_date" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3 col-xs-11">
                                                <input name="date" class="form-control form-control-inline input-medium default-date-picker"  size="20" type="text" value="" name = "end_date" />
                                            </div>
                                        </div>
