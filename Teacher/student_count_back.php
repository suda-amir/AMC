...
$query = "SELECT `subject`, `class`, `division`, `date`, `count`, `lesson_plan`, `teacher` FROM `attendance_record` WHERE `class` = '$year' AND `division` = '$division' AND date BETWEEN $yyyy_mm_dd and $yyyy_mm_dd2 AND `subject` = '$subject";
